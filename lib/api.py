...
class CoinexPerpetualApi(object):
    ...
    def __init__(self, access_id, secret_key):
        ...
        self.request_client = reques_client.RequestClient(access_id, secret_key)
        self.request_client_spot = request_client_spot.RequestClient(access_id, secret_key)
    ...
    def get_deposite_address(self, market, chain):
        path = '/balance/deposit/address/{market}'.format(market=market)
        data = {
            'access_id': self.access_id,
            'smart_contract_name': chain,
        }
        return self.request_client_spot.get(path, data)
    
    def submit_withdraw(self, market, chain, target, amount):
        ...
        data = {
            ...
            'smart_contract_name': chain,
            'coin_address': target,
            'transfer_method': 'Normal transfer local',
            'actual_amount': amount
        }
        return self.request_client_spot.post(path, data)
    
    def transfer(self, market, status, amount):
    ...
    def setsl(self, market, position_id, stop_type, stop_loss_price):
    ...
    def settp(self, market, position_id, stop_type, take_profit_price):
    ...
    def close_pos(self, market, position_id):
        path = "/v1/order/close_market"
        data ={
            'market': market,
            'position_id': position_id
